...
function SecondChanceBracketOneTable() {
    ...
    // Post
    function postSecondChanceOneBracketTable() {

        axios.post(serverUrl + '/admin/brackets/second-chance/one/post', {
            bracket: 'second_chance_bracket_one',
            bracketGame: 'second_chance_bracket_one_games',
            ...
            if (!response) {
                ...
                console.log('Error in postSecondChanceOneBracketTable()');
                return
            } else {
    ...
    return (
        <>
            ...
            <div className="all_scores_admin_save_button">
                <input type="button" value="Sauvegarder" className="btn btn--primary--dark btn--large" onClick={postSecondChanceOneBracketTable} />
            </div>
            <ToastContainer />
        </>
    )
...
export default SecondChanceBracketOneTable
