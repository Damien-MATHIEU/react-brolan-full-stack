...
function SmallFinalTwoTable() {
    ...
    function postLoserBracketTable() {
        ...
        axios.post(serverUrl + '/admin/brackets/small-final/two/post', {
            bracket: 'small_final_two',
            bracketGame: 'small_final_two_games',
...
export default SmallFinalTwoTable
