...
function OpeningBracketTwoTable() {
    ...
    // Post
    function postOpeningBracketTwoTable() {

        axios.post(serverUrl + '/admin/brackets/opening/post', {
            bracket: 'opening_bracket_two',
            bracketGame: 'opening_bracket_two_games',
    ...
    return (
        <>
                        ...
                        <tr>
                            ...
                            <td>
                                <select onChange={(e) => {
                                    ...
                                    totalScoreCalculate()
                                }} id="score_team_three_round_three">
                            ...
                            <td>
                                <select onChange={(e) => {
                                    ...
                                    totalScoreCalculate()
                                }} id="score_team_three_round_four">
                            ...
                            <td>
                                <select onChange={(e) => {
                                    ...
                                    totalScoreCalculate()
                                }} id="score_team_three_round_five">
                        ...
                        <tr>
                            ...
                            <td>
                                <select onChange={(e) => {
                                    ...
                                    totalScoreCalculate()
                                }} id="score_team_four_round_three">
                        ...
                        <tr>
                            ...
                            <td>
                                <select onChange={(e) => {
                                    ...
                                    totalScoreCalculate()
                                }} id="score_team_five_round_three">
            ...
            <div className="all_scores_admin_save_button">
                <input type="button" value="Sauvegarder" className="btn btn--primary--dark btn--large" onClick={postOpeningBracketTwoTable} />
            </div>
            <ToastContainer />
        </>
    )
    ...
    function totalScoreCalculate() {
        ...
        totalScoreTeamThree.innerHTML = parseInt(document.getElementById('score_team_three_round_one').value) + parseInt(document.getElementById('score_team_three_round_two').value) + parseInt(document.getElementById('score_team_three_round_three').value) + parseInt(document.getElementById('score_team_three_round_four').value) + parseInt(document.getElementById('score_team_three_round_five').value)
        totalScoreTeamFour.innerHTML = parseInt(document.getElementById('score_team_four_round_one').value) + parseInt(document.getElementById('score_team_four_round_two').value) + parseInt(document.getElementById('score_team_four_round_three').value) + parseInt(document.getElementById('score_team_four_round_four').value) + parseInt(document.getElementById('score_team_four_round_five').value)
        totalScoreTeamFive.innerHTML = parseInt(document.getElementById('score_team_five_round_one').value) + parseInt(document.getElementById('score_team_five_round_two').value) + parseInt(document.getElementById('score_team_five_round_three').value) + parseInt(document.getElementById('score_team_five_round_four').value) + parseInt(document.getElementById('score_team_five_round_five').value)
        totalScoreTeamSix.innerHTML = parseInt(document.getElementById('score_team_six_round_one').value) + parseInt(document.getElementById('score_team_six_round_two').value) + parseInt(document.getElementById('score_team_six_round_three').value) + parseInt(document.getElementById('score_team_six_round_four').value) + parseInt(document.getElementById('score_team_six_round_five').value)
    }

}

export default OpeningBracketTwoTable
