...
function WinnerBracketTableTwo() {
    ...
    // Post
    function postWinnerBracketTable() {

        axios.post(serverUrl + '/admin/brackets/winner/two/post', {
            bracket: 'winner_bracket_two',
            bracketGame: 'winner_bracket_two_games',
            ...
            if (!response) {
                ...
                console.log('Error in postWinnerBracketTable()');
                return
            } else {
    ...
    return (
        <>
            ...
            <div className="all_scores_admin_save_button">
                <input type="button" value="Sauvegarder" className="btn btn--primary--dark btn--large" onClick={postWinnerBracketTable} />
            </div>
            <ToastContainer />
        </>
    )
...
export default WinnerBracketTableTwo
