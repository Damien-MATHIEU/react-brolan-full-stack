...
function LoserBracketTableOne() {
    ...
    function postLoserBracketTable() {
        ...
        axios.post(serverUrl + '/admin/brackets/loser/one/post', {
            bracket: 'loser_bracket_one',
            bracketGame: 'loser_bracket_one_games',
...
export default LoserBracketTableOne
