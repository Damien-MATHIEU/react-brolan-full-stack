...
function WinnerBracketTableOne() {
    ...
    function postWinnerBracketTable() {
        ...
        axios.post(serverUrl + '/admin/brackets/winner/one/post', {
            bracket: 'winner_bracket_one',
            bracketGame: 'winner_bracket_one_games',
...
export default WinnerBracketTableOne
